...
public class DataStorageMySQLGeneric<T extends IRType<T>> extends DataStorageSQLBaseGeneric<T> {

//	public DataStorageMySQL(ILogger logger, String treeName, int numDimensions) {
	public DataStorageMySQLGeneric(ILogger logger, Class<T> clazz) {
